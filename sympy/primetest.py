...
def aks(n):
    ...
    >>>from sympy import aks
    >>>aks(1672939)
    Prime
    #1672939 is a proven prime
    
    >>>aks(36729183)
    Not Prime
    #36729183 is  3 * 12243061
    
    References
    ==========
    
    .. [1] https://en.wikipedia.org/wiki/AKS_primality_test
    .. [2] https://www.cse.iitk.ac.in/users/manindra/algebra/primality_v6.pdf
        ...
        def test_func2(n):
            ...
            while nexr == True:
                ...
                while k <= mk and nexr == False:
                    k = k+1
                    if func_exp(n,k,r) == 0 or func_exp(n,k,r) == 1:
                        nexr = True
            return r
        r = test_func2(n)
        if test_func3(n, r) != False:
            if test_func4(n, r) != True:
                def test_func5(n, r):
                    x = 7
                    max = math.sqrt(phi(r))
                    rn = math.floor(max*math.log2(n))
                    cache = func_exp(x,n,n)
